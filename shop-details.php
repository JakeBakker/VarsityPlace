                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        ...
                        <div class="product-price">
                            <div class="product__item__price">R<?php echo $product['price_current'] ?>
                                <span>R<?php echo $product['price_old'] ?></span>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="product__discount__item">
                            ...
                            <div class="product__discount__item__text">
                                ...
                                <div class="product__item__price">R<?php echo $price_current; ?>
                                    <span>R<?php echo $price_old; ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
