...
<div class="humberger__menu__wrapper">
    <div class="humberger__menu__logo">
        <a href="./"><img src="./src/images/LogoMain.png" alt=""></a>
    </div>
    ...
    <div class="humberger__menu__contact">
        <ul>
            <li><i class="fa fa-envelope"></i> VarsityPlace@gmail.com </li>
            <li>Free Shipping for all Orders over R500</li>
        </ul>
    </div>
</div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <div class="header__cart">
                    ...
                    <div class="header__cart__price">Total: <span>R<?= number_format($total_price, 2); ?></span>
                    </div>
                </div>
            </div>
        </div>
