...
<body>
    ...
    <div class="container">
                ...
                <tbody>
                    ...
                    foreach ($cart as $index => $item) {
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="price">
                                    <del>R<?= number_format($price_old, 2); ?></del>
                                    <span>R<?= number_format($price_current, 2); ?></span>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="price">
                                    <del>R<?= number_format($price_old * $item['number_of_products'], 2); ?></del>
                                    <span>R<?= number_format($price_current * $item['number_of_products'], 2); ?></span>
                                </div>
                            </td>
                        </tr>
                        <?php
        ...
        <div class="total">
            <p>Total (Old Price): <span><del>R<?= number_format($price_old_Sum, 2); ?></del></span></p>
            <p>Total (Current Price): <span style="color: #7fad39">R<?= number_format($price_current_Sum, 2); ?></span>
            </p>
        </div>
    </div>
