                                    ...
                                    <?php foreach ($cartItems as $item) { ?>
                                        <tr>
                                            ...
                                            <td class="shoping__cart__price">
                                                <del>R<?php echo number_format($item['price_old'], 2); ?></del>
                                                R<?php echo number_format($item['price_current'], 2); ?>
                                            </td>
                                            ...
                                            <td class="shoping__cart__total">
                                                R<?php echo number_format($item['total_price'], 2); ?>
                                            </td>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="shoping__checkout">
                        <h5>Cart Total</h5>
                        <ul>
                            <li>Subtotal <span>R<?php echo number_format($total_price, 2); ?></span></li>
                            <li>Total <span>R<?php echo number_format($total_price, 2); ?></span></li>
                        </ul>
